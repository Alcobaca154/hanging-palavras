...
export const portugueseNormal: WordEntry[] = [
  ...
  { word: "pavão", hint: "a bird with a beautiful colourful tail", category: "Animals" },
  { word: "lince", hint: "a wild cat with tufted ears", category: "Animals" },
  { word: "camelo", hint: "a desert animal with humps", category: "Animals" },
  // Cores
  ...
  { word: "violeta", hint: "the colour of grapes", category: "Colours" },
  { word: "cinzento", hint: "the colour of clouds on a rainy day", category: "Colours" },
  { word: "lilás", hint: "a soft light purple colour", category: "Colours" },
  // Comida
  ...
  { word: "manga", hint: "a sweet tropical yellow fruit", category: "Food" },
  { word: "goiaba", hint: "a tropical pink or white fruit", category: "Food" },
  { word: "limão", hint: "a yellow sour fruit", category: "Food" },
  { word: "alface", hint: "a green leafy salad vegetable", category: "Food" },
  // Corpo
  ...
  { word: "dedão", hint: "the biggest finger on your hand", category: "Body" },
  // Natureza
  ...
  { word: "petala", hint: "the colourful part of a flower", category: "Nature" },
  ...
  { word: "colchão", hint: "the soft thing we sleep on", category: "Home" },
  { word: "porta", hint: "we open this to enter a room", category: "Home" },
  { word: "cadeira", hint: "we sit on this at the table", category: "Home" },
];
